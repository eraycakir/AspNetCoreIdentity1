...
namespace UdemyIdentity1.Models.ViewModels
{
    public class PasswordChangeViewModel
    {
        ...
        [MinLength(4, ErrorMessage = "Şifreniz en az 4 karakterki olmak zorundadır.")]
        ...
        [DataType(DataType.Password)]
        [MinLength(4, ErrorMessage = "Şifreniz en az 4 karakterki olmak zorundadır.")]
        [Compare(nameof(PasswordNew), ErrorMessage = "Yeni şifreniz ve onay şifreniz birbirinden farklıdır.")]
